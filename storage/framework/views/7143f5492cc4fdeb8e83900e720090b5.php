      ...
      <table class="table table-hover mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo e(route('kasir.struk',$t->id)); ?>" target="_blank" class="btn btn-sm btn-outline-primary py-0 px-2" title = "struk"><i class="bi bi-receipt"></i></a>
            </td>
          </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\toko-madura\resources\views/catatan-penjualan/index.blade.php ENDPATH**/ ?>