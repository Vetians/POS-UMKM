...
<style>
body{margin:0;min-height:100vh;display:flex;align-items:center;justify-content:center;font-family:'Segoe UI',sans-serif;background:url('<?php echo e(asset('img/login/background.png')); ?>') center/cover no-repeat;position:relative;}
