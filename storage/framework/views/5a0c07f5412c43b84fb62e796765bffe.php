  ...
  <div class="col-6 col-md-4 col-xl-3">
    <div class="produk-card">
      ...
      <div class="fab-group">
        ...
        <button class="edit-fab" onclick='editProduk(<?php echo e(json_encode($p)); ?>, this)'><i class="bi bi-pencil"></i></button>
      </div>
    </div>
  </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\toko-madura\resources\views/produk/index.blade.php ENDPATH**/ ?>